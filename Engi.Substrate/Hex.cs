...
{
    // based on https://gist.github.com/antoninkriz/915364de7f264dd14a572936abd5228b
    ...
    public static unsafe string GetString(byte[] array)
    {
        ...
        var result = new string((char)0, array.Length * 2);
        
        fixed (byte* bytesP = array)
    ...
    public static unsafe byte[] GetBytes(ReadOnlySpan<char> hexData)
    {
